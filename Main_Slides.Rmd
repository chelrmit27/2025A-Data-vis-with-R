...
Australia faced food inflation, but less severely than peers — with peaks of 11% versus global highs of 16%. While resilient, price rises still strained household budgets.
---
...
```
Inflation hit unevenly — eggs, dairy, and oils spiked more than others. These category-specific pressures hint at underlying weaknesses in how food gets from farms to shelves.
---
...
<div class="custom-section-header">
  ...
  <div class="section-title">Proposed Mitigations</div>
</div>
...
<div class="overlay-text">
  ...
  <p>Turn research into resilience<br>
  → Scale up climate tools with subsidies and field support.</p>

  <h3>Regional Food Hubs</h3>
  <p>Build local buffers<br>
  → Invest in regional hubs to reduce freight risk and rural delays.</p>

  <h3>Transparent Food Pricing</h3>
  <p>Expose hidden markups<br>
  → Strengthen ACCC to trace prices from farm to shelf.</p>

  <h3>Stable Seasonal Labor</h3>
  <p>Protect farm work continuity<br>
  → Co-fund income safety nets and fast-track harvest visas.</p>
</div>
</section>
<!-- --- -->
